...
export default function Onboarding1View({ onNext, onSkip }) {
  return (
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-margin-mobile pt-20 pb-32">
        <div className="w-full max-w-container-max flex flex-col md:flex-row md:items-center md:gap-stack-lg">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start mb-stack-lg md:mb-0">
            <div className="relative w-full h-[200px] bg-surface-container/30 border border-primary/5 rounded-lg mb-stack-md flex items-center justify-center overflow-hidden">
              <div className="absolute top-1/2 left-0 right-0 h-[1px] bg-primary/10"></div>
              <div className="absolute top-1/2 left-1/2 w-3.5 h-3.5 bg-secondary rounded-full -translate-x-1/2 -translate-y-1/2 animate-ping opacity-70"></div>
              <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-secondary rounded-full -translate-x-1/2 -translate-y-1/2"></div>
              <span className="absolute left-4 top-[58%] font-label-sm text-label-sm opacity-40 text-[11px] uppercase tracking-wider">Analytical</span>
              <span className="absolute right-4 top-[58%] font-label-sm text-label-sm opacity-40 text-[11px] uppercase tracking-wider">Creative</span>
            </div>
            ...
            <div className="hidden md:block w-full h-[280px] rounded-lg overflow-hidden border border-primary/10">
              <img 
                ...
                alt="A minimalist balanced river stone on light beige surface"
